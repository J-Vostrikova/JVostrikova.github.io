  ...
  console.log("DOM fully loaded and parsed");
    btn.onclick = function(){ 
      ...
      var pro = parseInt(cena.value) *parseInt(kol.value);
        ...
        if(reg.test(cena.value)===true && reg.test(kol.value)===true) {
          oc();
          ok();
        }
      ...
      alert(" Ошибка: введите корректные данные")
          if(reg1.test(cena.value)===true && reg1.test(kol.value)===true) {
            oc();
            ok();
          }
      ...
      else if(reg1.test(kol.value)===true) {
        on();
        ok();
      }
    }
      ...
      alert(" Ошибка: введите коректные данные")
       if(reg2.test(cena.value)===true && reg2.test(kol.value)===true) {
         oc();
         ok();
       }
    ...
    else if(reg2.test(kol.value)===true) {
      on();
      ok();
    }
   }
